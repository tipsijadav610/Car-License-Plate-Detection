...
TRAIN_CLASSES               = "./model_data/coco/classes.names"
TRAIN_ANNOT_PATH            = "./model_data/coco/license_plate_train.txt"
TRAIN_LOGDIR                = "log"
...
# TEST options
TEST_ANNOT_PATH             = "./model_data/coco/license_plate_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 512
TEST_DATA_AUG               = False
