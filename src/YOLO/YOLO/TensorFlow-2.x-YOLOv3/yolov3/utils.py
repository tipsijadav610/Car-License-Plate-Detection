...
def detect_image(Yolo, image_path, output_path, input_size=512, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.5, iou_threshold=0.45, rectangle_colors=''):
